    ...
    <div className="bg-gray-900 text-gray-300 min-h-screen flex flex-col items-center justify-center p-4 sm:p-6">
      ...
      <Card className="bg-gray-800 text-gray-300 mt-6 w-full max-w-md sm:max-w-3xl shadow-lg">
        <p className="text-base sm:text-lg leading-relaxed text-center">
          The John Connor Project is dedicated to empowering IT and
          cybersecurity professionals to defend Main Street from AI-driven
          threats. Just as mechanics, electricians, and plumbers are essential
          to physical infrastructure, cybersecurity experts must become the
          protectors of digital freedom. Our mission is to educate, connect, and
          mobilize technologists to safeguard individuals from surveillance,
          data exploitation, and AI-based manipulation.
        </p>
      </Card>
      ...
      >
        <Link href="/get-involved">
          <Button className="w-full sm:w-auto bg-cyan-400 hover:bg-cyan-500 text-gray-900 font-semibold px-6 py-3 rounded-xl shadow-lg">
            Join the Resistance
          </Button>
        </Link>
      </motion.div>
