...
const sections: GearSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        name: "Ubiquiti UniFi G4 Bullet",
        desc: "Outdoor 4MP PoE IP camera — the workhorse of a UniFi Protect system.",
        ...
        price: "Mid-Range",
        url: amz("Ubiquiti UniFi G4 Bullet camera UVC-G4-BULLET"),
      },
      {
        name: "Ubiquiti UniFi G4 Dome",
        desc: "Compact ceiling/soffit-mount dome camera for covered areas.",
        ...
        price: "Mid-Range",
        url: amz("Ubiquiti UniFi G4 Dome camera UVC-G4-DOME"),
      },
      {
        name: "Ubiquiti UniFi UNVR",
        desc: "4-bay Network Video Recorder — dedicated local storage for UniFi Protect.",
        ...
        price: "Pro",
        url: amz("Ubiquiti UniFi UNVR Network Video Recorder"),
      },
      {
        name: "Reolink RLC-810A",
        desc: "4K PoE IP camera — best value for local recording.",
        ...
        price: "Budget",
        url: amz("Reolink RLC-810A 4K PoE IP camera"),
      },
      {
        name: "Reolink 8-Channel NVR Bundle",
        desc: "NVR + 4 or 8 PoE cameras — all-in-one starter system.",
        ...
        price: "Budget",
        url: amz("Reolink 8 channel NVR PoE camera system"),
      },
      {
        name: "Ubiquiti G4 Doorbell",
        desc: "PoE video doorbell that integrates with UniFi Protect.",
        ...
        price: "Mid-Range",
        url: amz("Ubiquiti UniFi G4 Doorbell UVC-G4-DOORBELL"),
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "WiFi deadbolt with Apple Home Key and keypad.",
        ...
        price: "Mid-Range",
        url: amz("Schlage Encode Plus smart deadbolt BE489WB"),
      },
      {
        name: "Yale Assure Lock 2",
        desc: "Slim touchscreen deadbolt — clean look, solid security.",
        ...
        price: "Mid-Range",
        url: amz("Yale Assure Lock 2 smart deadbolt"),
      },
      {
        name: "Ubiquiti UniFi Access Hub",
        desc: "Enterprise-grade door access controller for UniFi ecosystems.",
        ...
        price: "Pro",
        url: amz("Ubiquiti UniFi Access Hub UA-HUB"),
      },
      {
        name: "Ubiquiti UA-Reader Lite",
        desc: "NFC/keycard reader for UniFi Access systems.",
        ...
        price: "Mid-Range",
        url: amz("Ubiquiti UniFi Access Reader Lite UA-Reader-Lite"),
      },
      {
        name: "Konnected Alarm Panel",
        desc: "Convert a wired alarm system to smart home compatible.",
        ...
        price: "Mid-Range",
        url: amz("Konnected Alarm Panel smart home wired sensors"),
      },
    ],
  },
  {
